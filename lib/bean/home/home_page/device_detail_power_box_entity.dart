...
class DeviceDetailPowerBoxEntity {
  ...
  factory DeviceDetailPowerBoxEntity.fromJson(Map<String, dynamic> json) =>
      $DeviceDetailPowerBoxEntityFromJson(json);
...
class DeviceDetailPowerBoxData {
  ...
  factory DeviceDetailPowerBoxData.fromJson(Map<String, dynamic> json) =>
      $DeviceDetailPowerBoxDataFromJson(json);
...
class DeviceDetailPowerBoxDataDcInterfaces {
  ...
  factory DeviceDetailPowerBoxDataDcInterfaces.fromJson(
          Map<String, dynamic> json) =>
      $DeviceDetailPowerBoxDataDcInterfacesFromJson(json);

  Map<String, dynamic> toJson() =>
      $DeviceDetailPowerBoxDataDcInterfacesToJson(this);
